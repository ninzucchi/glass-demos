...
> = {
  ...
  lg: { box: 28, radius: 6, icon: "lg", hover: "tertiary" },
};
...
export const IconButton = forwardRef<HTMLButtonElement, IconButtonProps>(
  ({ name, size = "base", active = false, disabled, className, style, ...props }, ref) => {
    const s = SPEC[size];
    return (
      <button
        ref={ref}
        ...
        className={clsx(
          ...
          "text-[color:var(--icon-secondary)] hover:text-[color:var(--icon-primary)]",
